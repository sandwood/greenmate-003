...
var gcs = require('@google-cloud/storage')({projectId: "greenmate-163904", keyFilename: '../config/keyfile', credentials: require('../config/keyfile')});
...
module.exports = function (passport) {
		...
		passport.use(new FacebookStrategy({
				...
				callbackURL: "http://www.nextfarmer.net/auth/facebook/callback",
				...
				User
						.findOne({
								...
								if (user) {
										...
										// request('https://graph.facebook.com/oauth/access_token?grant_type=fb_exchange
										// _
										// token&client_id=1805972802984860&client_secret=48c8d93553d87b2cb16f5552d54772
										// d 2&fb_exchange_token='+accessToken +'/',function(err, res, body){
										...
										gcs.createBucket(bucketName, function (err, bucket) {
												...
												user.save(function (error, user) {
														...
														userBucket
																.acl
																.default
																.add(options, function (err, aclObject) {
																		if (err) {
																				console.log(err);
																				return cb(err);
																		}
		...
		passport.use(new KakaoStrategy({
				...
				callbackURL: "http://www.nextfarmer.net/auth/kakao/callback"
		}, function (accessToken, refreshToken, profile, done) {
				User
						.findOne({
								$and: [
										{
												id: profile.id + "@kakao.com"
										}, {
												block: 0
										}
								]
